            ...
            this.dropZone = new Ext.dd.DropZone(this.getEl(), {
                ...
                onNodeDrop: function(target, dd, e, data) {
                    ...
                    if (targetRec.getId() !== data.sourceRec.getId()) {
                        ...
                        options = {computeId:computeId, destMachineId:destMachineId, srcMachineId:srcMachineId, srcHost:data.sourceRec.get('hostname'), destHost:targetRec.get('hostname'), nodeName:nodeName, vmmap:data.vmmap}
